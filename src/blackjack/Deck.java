...
public class Deck {
	...
	private String filechar;				//for GUI - part of file name for card image
	private String filerank;				//for GUI - part of file name for card image			
	private String imgFile;					//for GUI - part of file name for card image			
